...
转化为zarr格式
python h52zarr.py --input-path /data2/lirui/StructureMap3D/maniskill/data/PickCube-v1/motionplanning/test.pointcloud.pd_ee_delta_pos.physx_cpu.h5 --zarr-save-dir ...